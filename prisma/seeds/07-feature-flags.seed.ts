...
export async function seedFeatureFlags(prisma: PrismaClient): Promise<void> {
  ...
  const flags = [
    {
      flag: 'TWO_FACTOR_ENFORCEMENT',
      enabled: false,
      description: 'Enforce 2FA for all admin accounts',
      rolloutPercentage: 0,
    },
    {
      flag: 'WEBHOOK_OUTBOUND',
      enabled: false,
    ...
    },
    {
      flag: 'BLOG_COMMENTS',
      enabled: true,
      description: 'Enable blog commenting system',
      rolloutPercentage: 100,
    },
    {
      flag: 'PORTFOLIO_PUBLIC',
      enabled: true,
      description: 'Make portfolio items publicly visible',
      rolloutPercentage: 100,
    },
    {
      flag: 'CHUNKED_UPLOADS',
      enabled: false,
      description: 'Enable chunked file upload support',
      rolloutPercentage: 0,
    },
    {
      flag: 'CDN_PROCESSING',
      enabled: false,
      description: 'Enable CDN processing for media files',
      rolloutPercentage: 0,
    },
  ];
