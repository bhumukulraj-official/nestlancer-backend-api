...
describe('CircuitBreakerService', () => {
    ...
    it('should open after threshold failures', async () => {
        ...
        await expect(service.execute('test', fn, options)).rejects.toThrow("Circuit breaker 'test' is OPEN");
    });
    ...
    it('should transition to half-open after timeout', async () => {
        ...
        // Circuit is OPEN
        await expect(service.execute('test', fnSuccess, options)).rejects.toThrow("Circuit breaker 'test' is OPEN");
