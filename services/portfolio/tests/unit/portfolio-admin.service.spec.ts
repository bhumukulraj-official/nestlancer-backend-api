...
describe('PortfolioAdminService', () => {
    ...
    const mockItem = { id: 'pi-1', title: 'Website', slug: 'website', status: 'PUBLISHED', featured: true, categoryId: 'cat-1', createdAt: new Date(), category: { name: 'Web' } };
    ...
    beforeEach(() => {
        ...
        mockPrismaWrite = {
            portfolioItem: {
                ...
                create: jest.fn().mockResolvedValue({ ...mockItem, id: 'pi-copy', title: 'Website (Copy)' }),
            },
        };
