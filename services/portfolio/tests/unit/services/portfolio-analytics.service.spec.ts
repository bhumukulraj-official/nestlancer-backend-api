...
describe('PortfolioAnalyticsService', () => {
    ...
    describe('getGlobalAnalytics', () => {
        it('should return aggregated global analytics', async () => {
            prismaRead.portfolioItem.aggregate.mockResolvedValue({ _sum: { viewCount: 50, likeCount: 10 } } as any);
    ...
    describe('getItemAnalytics', () => {
        it('should return analytics for given item', async () => {
            prismaRead.portfolioItem.findUnique.mockResolvedValue({ viewCount: 5, likeCount: 1, createdAt: new Date() } as any);
