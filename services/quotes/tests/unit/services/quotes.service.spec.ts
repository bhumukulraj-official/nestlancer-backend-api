...
describe('QuotesService', () => {
    ...
    const mockQuote = {
        id: 'quote-1', requestId: 'req-1', status: 'SENT', totalAmount: 5000, currency: 'INR',
        validUntil: new Date(Date.now() + 86400000 * 7), createdAt: new Date(),
        ...
        subtotal: 5000, taxRate: 0, taxAmount: 0,
        sentAt: new Date(), viewedAt: null, acceptedAt: null, declinedAt: null,
        attachments: [],
    };
