...
describe('EmailVerificationService', () => {
    ...
    beforeEach(() => {
        mockPrismaRead = {
            ...
            user: {
                findUnique: jest.fn().mockResolvedValue({ id: 'user-1', email: 'test@example.com', emailVerified: false }),
            },
        };
        mockPrismaWrite = {
            $transaction: jest.fn().mockImplementation(async (fn) => {
                const tx = {
                    ...
                    verificationToken: { delete: jest.fn().mockResolvedValue({}), create: jest.fn().mockResolvedValue({}) },
