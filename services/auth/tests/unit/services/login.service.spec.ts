...
describe('LoginService', () => {
    ...
    beforeEach(() => {
        ...
        service = new LoginService(mockPrismaRead, mockPrismaWrite, mockLockoutService, mockTokenService);
    });
    ...
    describe('authenticate', () => {
        ...
        it('should throw BusinessLogicException for non-existent user', async () => {
            ...
            await expect(service.authenticate(loginDto, ipAddress, userAgent))
                .rejects.toThrow();
        });
        ...
        it('should throw BusinessLogicException for invalid password', async () => {
            ...
            await expect(service.authenticate(loginDto, ipAddress, userAgent))
                .rejects.toThrow();
            expect(mockLockoutService.handleFailedAttempt).toHaveBeenCalledWith('user-1', mockUser.authConfig);
        });
