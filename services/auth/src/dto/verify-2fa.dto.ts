...
export class Verify2FADto {
  @ApiProperty({
    ...
    description:
      'The temporary authentication session ID issued after a successful first-factor login',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    example: '123456',
    description:
      'The numeric 6-digit TOTP code or an 8-10 character alphanumeric backup recovery code',
  })
  @IsString()
  @IsNotEmpty()
