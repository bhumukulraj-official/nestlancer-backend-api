...
describe('ProgressService', () => {
        ...
        mockPrismaRead = {
            progressEntry: {
                findMany: jest.fn().mockResolvedValue([
                    { id: 'pe-1', type: 'UPDATE', title: 'Progress', projectId: 'proj-1', createdAt: new Date() },
                ]),
        ...
        mockPrismaWrite = {
            progressEntry: {
                create: jest.fn().mockResolvedValue({
                    id: 'pe-new', projectId: 'proj-1', type: 'UPDATE', title: 'New Update',
                    visibility: 'CLIENT_VISIBLE', clientNotified: true,
                }),
    ...
    describe('createEntry', () => {
        it('should create a progress entry', async () => {
            const dto = { type: 'UPDATE', title: 'New Update', description: 'Details', visibility: 'CLIENT_VISIBLE', notifyClient: true };
