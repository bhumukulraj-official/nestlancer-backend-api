...
export class MilestoneResponseDto {
  ...
  @ApiProperty({
    required: false,
    example: 'Deep dive into user requirements and market analysis',
  ...
  @ApiProperty({
    ...
    description: 'Timestamp of client approval',
  })
  approvedAt?: Date;

  @ApiProperty({
    example: 1,
    description: 'Display order of the milestone in the project sequence',
  })
  order: number;
}
