...
describe('ProgressController', () => {
    ...
    describe('getTimeline', () => {
        it('should return the project timeline', async () => {
            mockTimelineService.getTimeline.mockResolvedValue({ items: [], meta: { total: 0, page: 1, limit: 20 } });
    ...
    describe('getStatusSummary', () => {
        it('should return project status summary', async () => {
            mockProgressService.getStatusSummary.mockResolvedValue({ percentageComplete: 50, currentPhase: 'Phase 1' });
