import { Controller, Get, Patch, Post, Delete, Body, Param, Query, UseGuards, HttpStatus } from '@nestjs/common';
...
export class UsersAdminController {
    ...
    async changeUserStatus(@Param('userId') userId: string, @Body('status') status: string): Promise<any> {
    ...
    async adminResetPassword(@Param('userId') userId: string, @Body('newPassword') newPassword?: string): Promise<any> {
