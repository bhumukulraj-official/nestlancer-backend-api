...
export class BlogCategoriesAdminController {
     ...
     */
    @Get()
    @ApiOperation({ summary: 'List all categories', description: 'Fetch all blog categories including their internal metadata.' })
     ...
     */
    @Post()
    @ApiOperation({ summary: 'Create category', description: 'Define a new organizational category for blog posts.' })
     ...
     */
    @Patch(':id')
    @ApiOperation({ summary: 'Update category', description: 'Modify the name, slug, or description of an existing category.' })
     ...
     */
    @Delete(':id')
    @ApiOperation({ summary: 'Delete category', description: 'Remove a blog category from the system.' })
...
export class BlogTagsAdminController {
     ...
     */
    @Get()
    @ApiOperation({ summary: 'List all tags', description: 'Fetch all blog tags used across the system.' })
    async findAll(): Promise<any> {
     ...
     */
    @Post()
    @ApiOperation({ summary: 'Create tag', description: 'Define a new blog tag for content categorization.' })
     ...
     */
    @Patch(':id')
    @ApiOperation({ summary: 'Update tag', description: 'Modify the name or slug of an existing blog tag.' })
     ...
     */
    @Post('merge')
    @ApiOperation({ summary: 'Merge tags', description: 'Consolidate multiple tags into one and update all associated blog posts.' })
