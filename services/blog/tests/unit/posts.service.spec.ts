...
describe('PostsService', () => {
    ...
    const mockPost = { id: 'post-1', title: 'Test Post', slug: 'test-post', status: 'PUBLISHED', publishedAt: new Date(), category: { name: 'Tech' }, tags: [] };
    ...
    beforeEach(() => {
        ...
        mockPrismaWrite = {
            blogPost: { create: jest.fn().mockResolvedValue({ ...mockPost, id: 'post-new', status: 'DRAFT' }) },
        };
    ...
    describe('create', () => {
        it('should create post with reading time', async () => {
            const result = await service.create({ title: 'Test', content: 'Hello world this is a test post', categoryId: 'cat-1' } as any);
