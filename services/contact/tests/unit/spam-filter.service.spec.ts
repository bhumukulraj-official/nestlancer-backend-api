...
describe('SpamFilterService', () => {
    ...
    it('should log low score for normal messages', () => {
        const result = service.checkSpam('john@gmail.com', 'Hello, this is a legitimate question about projects.');
        expect(result.isSpam).toBe(false);
    });

    it('should log high score for spammer texts', () => {
        const spamText = 'buy followers SEO services http://link1.com http://link2.com http://link3.com http://link4.com http://link5.com';
