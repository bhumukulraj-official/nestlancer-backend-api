...
describe('AuditService', () => {
    ...
    const mockLog = { id: 'log-1', action: 'LOGIN', category: 'AUTH', description: 'User logged in', userId: 'user-1', createdAt: new Date(), user: { id: 'user-1', name: 'John', email: 'test@example.com' } };
    ...
    describe('createLog', () => {
        it('should create an audit log entry', async () => {
            const result = await service.createLog({ action: 'LOGIN', category: 'AUTH', description: 'User logged in', userId: 'user-1' });
            expect(result.action).toBe('LOGIN');
