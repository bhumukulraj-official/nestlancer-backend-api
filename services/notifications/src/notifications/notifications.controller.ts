import { Controller, Get, Patch, Post, Delete, Param, Query, Body, UseGuards, HttpCode } from '@nestjs/common';
...
export class NotificationsController {
     ...
     */
    @Get()
    @ApiOperation({ summary: 'Get current user notifications', description: 'Fetch all active and unread notifications belonging to your account.' })
    @ApiPaginated()
     ...
     */
    @Get('unread-count')
    @ApiOperation({ summary: 'Get unread notification count', description: 'Retrieve the total number of notifications that have not yet been acknowledged.' })
