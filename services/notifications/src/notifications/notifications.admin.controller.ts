...
export class NotificationsAdminController {
     ...
     */
    @Get()
    @ApiOperation({ summary: 'Get all notifications (Admin)', description: 'Access the global repository of notification records for audit and review.' })
    @ApiPaginated()
     ...
     */
    @Get('stats')
    @ApiOperation({ summary: 'Get notification statistics', description: 'Monitor high-level notification volume and status distribution platform-wide.' })
