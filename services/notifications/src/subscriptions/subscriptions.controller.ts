...
export class SubscriptionsController {
     ...
     */
    @Post()
    @ApiOperation({ summary: 'Register web push subscription', description: 'Enroll a device for receiving real-time browser push notifications.' })
     ...
     */
    @Delete()
    @ApiOperation({ summary: 'Remove web push subscription', description: 'Deactivate and delete a previously registered push notification endpoint.' })
    @ApiStandardResponse(Object)
