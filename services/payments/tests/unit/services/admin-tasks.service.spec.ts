...
import {
  ...
  PaymentStatsService,
} from '../../../src/services/admin-tasks.service';
  ...
  describe('PaymentDisputesService', () => {
    ...
    describe('getDisputes', () => {
      it('should return paginated disputes', async () => {
        prismaRead.payment.findMany.mockResolvedValue([
          { id: '1', amount: 100, client: {}, project: {} },
        ] as any);
        ...
        expect(prismaRead.payment.findMany).toHaveBeenCalledWith(
          expect.objectContaining({
            where: expect.objectContaining({
              refundStatus: { in: ['DISPUTED', 'DISPUTE_PENDING', 'DISPUTE_WON', 'DISPUTE_LOST'] },
            }),
          }),
        );
    ...
    describe('resolveDispute', () => {
      ...
      it('should resolve dispute and create outbox event', async () => {
        ...
        expect(prismaWrite.outboxEvent.create).toHaveBeenCalledWith(
          expect.objectContaining({
