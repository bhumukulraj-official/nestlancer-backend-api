...
export class PaymentDisputesAdminController {
     ...
     */
    @Get('disputes')
    @ApiOperation({ summary: 'List payment disputes', description: 'Access the global repository of payment disputes for administrative review and resolution.' })
    ...
    @ApiOperation({ summary: 'Resolve a dispute', description: 'Emit an administrative decision to close an active payment dispute.' })
