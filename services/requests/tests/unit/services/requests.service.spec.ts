...
describe('RequestsService', () => {
    ...
    describe('submitRequest', () => {
        ...
        it('should throw if request not found', async () => {
            ...
            await expect(service.submitRequest('user1', 'req1')).rejects.toThrow(BusinessLogicException);
        });
        ...
        it('should throw if missing budget', async () => {
            ...
            await expect(service.submitRequest('user1', 'req1')).rejects.toThrow('Cannot submit incomplete request');
        });
    });
});
