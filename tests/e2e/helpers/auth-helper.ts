...
export async function registerUser(
  ...
  const data: RegisterPayload = {
    ...
    turnstileToken:
      payload?.turnstileToken || process.env.TURNSTILE_BYPASS_TOKEN || 'e2e-bypass-token',
  };
 ...
 */
export async function refreshToken(client: E2EHttpClient, refreshTokenValue: string): Promise<any> {
