...
describe('CloudFrontInvalidationService', () => {
    ...
    describe('invalidate', () => {
        it('should call CloudFront client to create invalidation', async () => {
            mockCloudFrontClient.send.mockResolvedValue({ Invalidation: { Id: 'inv1', Status: 'Completed' } } as any);
    ...
    describe('purgeAll', () => {
        it('should invalidate /* path', async () => {
            mockCloudFrontClient.send.mockResolvedValue({ Invalidation: { Id: 'inv-all', Status: 'Completed' } } as any);
