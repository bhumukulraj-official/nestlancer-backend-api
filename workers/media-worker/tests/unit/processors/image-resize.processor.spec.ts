...
describe('ImageResizeProcessor', () => {
    ...
    describe('process', () => {
        it('should process image and create variants based on config', async () => {
            ...
            expect(storage.upload).toHaveBeenCalledWith('test-bucket', 'small_test.jpg', resizedBuffer, 'image/webp');
            expect(storage.upload).toHaveBeenCalledWith('test-bucket', 'medium_test.jpg', resizedBuffer, 'image/webp');
