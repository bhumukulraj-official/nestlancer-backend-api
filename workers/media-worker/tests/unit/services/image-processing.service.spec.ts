...
describe('ImageProcessingService', () => {
    ...
    describe('extractMetadata', () => {
        it('should extract metadata from image', async () => {
            const mockMetadataData = { width: 800, height: 600, format: 'jpeg', space: 'srgb', exif: Buffer.from('') };
            ...
            expect(result).toEqual({ width: 800, height: 600, format: 'jpeg', colorSpace: 'srgb', exif: 'present' });
        });
