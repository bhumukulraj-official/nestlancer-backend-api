...
describe('UserAnalyticsProcessor', () => {
    ...
    it('should process and save user analytics', async () => {
        aggregationService.aggregate
            ...
            .mockResolvedValueOnce([{ role: 'CLIENT', _count: { id: 60 } }, { role: 'FREELANCER', _count: { id: 40 } }] as any) // roles
            .mockResolvedValueOnce([{ status: 'ACTIVE', _count: { id: 90 } }, { status: 'SUSPENDED', _count: { id: 10 } }] as any); // statuses
