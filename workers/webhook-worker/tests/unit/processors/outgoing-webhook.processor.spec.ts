...
describe('OutgoingWebhookProcessor', () => {
    ...
    describe('handleOutgoing', () => {
        ...
        it('should send webhook and log success', async () => {
            prismaRead.webhook.findUnique.mockResolvedValue({ id: 'w1', enabled: true, url: 'https://test.com', secret: 'sec' } as any);
            const mockResponse: AxiosResponse = { status: 200, data: 'OK', statusText: 'OK', headers: {}, config: {} as any };
            ...
            expect(webhookLogger.logDelivery).toHaveBeenCalledWith('w1', 'project.created', { id: 'p1' }, {
                statusCode: 200,
                responseBody: '"OK"',
