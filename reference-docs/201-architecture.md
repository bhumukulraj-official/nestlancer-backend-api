...
%% ═════════════════════════════════════════════════
MQ -->|"routing: webhook._"| WH_WORKER
MQ -->|"routing: email._"| EMAIL_W
MQ -->|"routing: notification._"| NOTIF_W
MQ -->|"routing: audit._"| AUDIT_W
MQ -->|"routing: media._"| MEDIA_W
MQ -->|"routing: portfolio._"| PORTFOLIO_W
MQ -->|"routing: analytics._"| ANALYTICS_W
ANALYTICS_W -->|"writes materialized views"| DB_W
MQ -->|"routing: cdn._"| CDN_W
